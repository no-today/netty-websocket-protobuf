...
public class Cookie {
    ...
    public Cookie(Channel channel, String principal, String credentials, Collection<? extends GrantedAuthority> authorities, boolean authenticated) {
    ...
    public Cookie(Channel channel, String principal, String credentials, Collection<? extends GrantedAuthority> authorities) {
        this(channel, principal, credentials, authorities, false);
    }

    public Cookie(Channel channel, String principal, String credentials) {
        this(channel, principal, credentials, Collections.emptyList());
    }
